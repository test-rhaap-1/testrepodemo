"""A hello-world filter plugin in dummynamespace.dummycollectionname."""
...
DOCUMENTATION = """
    name: hello_world
    author: Dummynamespace Dummycollectionname
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | dummynamespace.dummycollectionname.hello_world }}"
"""
